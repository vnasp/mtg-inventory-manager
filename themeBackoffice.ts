...
const themeBackoffice = createTheme({
  ...
  pagination: {
    ...
    pages: {
      ...
      previous: {
        base: 'ml-0 rounded-l-lg border border-gray-300 bg-white px-3 py-2 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700',
        icon: 'h-5 w-5',
      },
      next: {
        base: 'rounded-r-lg border border-gray-300 bg-white px-3 py-2 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700',
        icon: 'h-5 w-5',
      },
      selector: {
        ...
        active:
          'bg-bo-primary text-white hover:bg-cyan-100 hover:text-cyan-700',
        disabled: 'cursor-not-allowed opacity-50',
      },
    },
  },
